...
// console.log(judge([5]))//true
// console.log(judge([13,13]))//true type:double value:13
// console.log(judge([13,14]))//false
// console.log(judge([14,15]))//true boom vlaue 100
// console.log(judge([3,3,3]))//type:TRIPLE true value:3
// console.log(judge([3,3,1]))//false
// console.log(judge([3,3,3,1]))//true 3p1 value 3
// console.log(judge([3,3,3,1,1]))//true 3p2 value 3
// console.log(judge([3,4,5,6,7]))//true SERIAL
// console.log(judge([4,4,4,4]))//true boom
// console.log(judge([4,4,4,5]))//true 3p1
// console.log(judge([4,4,4,4,5]))//false 
// console.log(judge([4,4,4,5,5,5]))//false 
// console.log(judge([4,4,5,5,6,6]))//false 
// console.log(judge([4,4,5,5,7,7]))//false 
// console.log(judge([13,13,14,14,15,15]))//false 
// console.log(judge([12,12,13,13,14,14]))//false 
// console.log(judge([4,4,4,6,6,6]))//false 
// console.log(judge([3,4,5,6,7,8]))//false 
// console.log(judge([3,4,5,6,7,8]))//false 
console.log(judge([3, 4, 5, 6, 7, 8])) //false 